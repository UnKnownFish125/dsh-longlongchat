window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
        ...
        function VirtualChatFlow({ order, nodeStore, listRef, prependRef, useSession, selectedCallId, cwd, openFile, inspectCall, forkAt, renderMessageImages, fileMentions, renderSlot, t, virtualApiRef, autoFollowRef }) {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)(VirtualChatFlow, { order, nodeStore, listRef, prependRef: anchorRef, useSession, selectedCallId, cwd, openFile: requestOpenFile, inspectCall, forkAt, renderMessageImages, fileMentions, renderSlot, t, virtualApiRef, autoFollowRef }),
